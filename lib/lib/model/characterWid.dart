      ...
      child: AnimatedBuilder(
        ...
        Align(
          alignment: Alignment.bottomCenter,
           child:
           ClipPath(
             clipper: CharacterCardBack(),
             child:
             Hero(
               tag: "background-${character.name}",
               child: Container(
                    //padding: EdgeInsets.symmetric(horizontal: screenHeight*0.5),
            ...
            Align(
              ...
              child: Hero(
                ...
                child: Image.asset(
                  character.imagesPath,
                  height: screenHeight * 0.55*value,
                ),
              ),
            ),
            Padding(
              padding: EdgeInsets.only(left:48.0, right: 16, bottom: 16),
              child: Column(
                       ...
                       Hero(
                         ...
                         child: Material(
                          color: Colors.transparent,
                            child:
                            Container(
                                child: Text(character.name, style: AppThem.heading,),

                            )
                         ),
                       ),
                  Text("Tap to Read more", style: AppThem.subheading,),
...
class CharacterCardBack extends CustomClipper<Path> {
  @override
  getClip(Size size) {
